...
WHERE from_stage NOT IN ('Closed Lost','closedlost', 'Closed Won','Closed Won - QA', 'Dead - No Decision', 'Dead - No opportunity');
...
AND from_stage NOT IN ('Closed Lost','closedlost', 'Closed Won','Closed Won - QA', 'Dead - No Decision', 'Dead - No opportunity');
